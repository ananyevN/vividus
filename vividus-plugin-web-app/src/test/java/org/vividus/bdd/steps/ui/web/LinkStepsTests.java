...
class LinkStepsTests
{
    ...
    void testIfLinkItemsWithTextAndLink()
    {
        ...
        Locator attributes = new Locator(WebLocatorType.LINK_TEXT, HOME).addFilter(
                WebLocatorType.LINK_URL, SLASH);
    ...
    void testIfLinkItemsWithTextExists()
    {
        ...
        Locator attributes = new Locator(WebLocatorType.LINK_TEXT, HOME);
